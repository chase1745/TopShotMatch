...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/CGRPCZlibp/CGRPCZlib.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/FCL-SDK/FCL_SDK.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/gRPC-Swiftp/GRPC.framework"
