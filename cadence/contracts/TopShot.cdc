...
import TopShotLocking from 0xaa3d8fb4584f9b91
...
pub contract TopShot: NonFungibleToken {
    ...
    pub fun RoyaltyAddress() : Address { return 0xaa3d8fb4584f9b91 }
    ...
    pub struct Play {
        ...
        // cond while we figure out a better way to do metadata.
        //
            ...
            switch view {
                ...
                case Type<MetadataViews.NFTCollectionDisplay>():
                    ...
                    return MetadataViews.NFTCollectionDisplay(
                        name: "TopShotMatch_hackathon_23_modified_topshot",
                        description: "Modified TopShot NFT for Flow Hackathon project - TopShotMatch.",
    ...
    pub resource interface MomentCollectionPublic {
        ...
        pub fun borrowMoments(): [&TopShot.NFT]
    ...
    pub resource interface AdminMintPublic {
        pub fun borrowSet(setID: UInt32): &Set
    }
    ...
    pub resource Collection: MomentCollectionPublic, NonFungibleToken.Provider, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection {
        ...
        pub fun borrowMoments(): [&TopShot.NFT] {
            var refs: [&TopShot.NFT] = []
            for id in self.ownedNFTs.keys {
                let ref = (&self.ownedNFTs[id] as auth &NonFungibleToken.NFT?)!
                refs.append(ref as! &TopShot.NFT)
            }
            return refs
        }
    ...
    // Give anyone the capability to mint moments (DANGER DON'T DEPLOY THIS TO MAINNET, this is for testing only)
    pub fun createAdminCollection(): @Admin {
        return <-create Admin()
    }
